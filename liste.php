 ...
 ?>
      <div class="card ">
        <div class="card-header">
          <h3><i class="fas fa-users mr-2"></i>User list <span class="float-right">Bienvenue! <strong>
          ...
          <table  style="width:100%">
                  <thead>
                    <tr>
                      ...
                      <th  class="text-center">Numéro de Serie</th>
                     ...
                     ?>
                      ...
                      >
                        ...
                        <td><?php echo $value->username; ?> <br>
                          ...
                          echo "<span class='badge badge-lg badge-dark text-white'>Médecin</span>";
                        }elseif ($value->roleid == '3') {
                            echo "<span class='badge badge-lg badge-dark text-white'>Parient</span>";
                        } ?></td>
