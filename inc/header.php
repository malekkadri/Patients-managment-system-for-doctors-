...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Systéme de management des patients </title>
          ...
          <?php if (Session::get('id') == TRUE) { ?>
            <?php if (Session::get('roleid') == '1') { ?>
              <li class="nav-item">
                  ...
                  <a class="nav-link" href="liste.php"><i class="fas fa-users mr-2"></i>Liste Patients </span></a>
              </li>
              <li class="nav-item
              ...
              <?php
                ...
                <a class="nav-link" href="addUser.php"><i class="fas fa-user-plus mr-2"></i>Ajouter Patient </span></a>
              </li>
            <?php  } ?>
            <li class="nav-item
            <?php
