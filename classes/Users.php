...
<strong>Error !</strong> Username is too short, at least 3 Characters !</div>';
      ...
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
<strong>Error !</strong> Enter only Number Characters for Telephone field !</div>';
        return $msg;
...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
      ...
      $sql = "INSERT INTO tbl_users(num, name, fname, username, email, password, mobile, genre, ville, poids, taille, roleid) VALUES(num:; :name, :fname; :username, :email, :password, :mobile, :genre, :ville, :poids, :taille, :roleid)";
      $stmt = $this->db->pdo->prepare($sql);
  ...
  // Ajouter nouveau patient By Admin
  public function addNewUserByAdmin($data){
    ...
    if ($name == "" || $fname == "" || $username == "" || $email == "" || $mobile == "" || $password == "") {
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
