    ...
    if ($getUinfo) {
     ...
     ?>
          ...
          <div class="form-group">
                ...
                <input type="number" name="num" value="<?php echo $getUinfo->num; ?>" class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="fname" value="<?php echo $getUinfo->fname; ?>" class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" id="ville" name="ville" value="<?php echo $getUinfo->ville; ?>" class="form-control">
              </div>
              <div class="form-group">
                <label for="mobile">Poids </label>
                <input type="text" id="poids" name="poids" value="<?php echo $getUinfo->poids; ?>" class="form-control">
              </div>
              <div class="form-group">
                <label for="mobile">Taille</label>
                <input type="text" id="taille" name="taille" value="<?php echo $getUinfo->taille; ?>" class="form-control">
              </div>
